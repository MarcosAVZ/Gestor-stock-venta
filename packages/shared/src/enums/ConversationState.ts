...
export const ConversationState = {
  ...
  EDITANDO_SELECCION: 'EDITANDO_SELECCION',
  EDITANDO_VALOR: 'EDITANDO_VALOR',
  ELIMINANDO_PRODUCTOS: 'ELIMINANDO_PRODUCTOS',
  PREGUNTANDO_CANTIDAD_AGREGAR: 'PREGUNTANDO_CANTIDAD_AGREGAR',
  PREGUNTANDO_COSTO_LOTE_AGREGAR: 'PREGUNTANDO_COSTO_LOTE_AGREGAR',
  VENDIENDO_SELECCION: 'VENDIENDO_SELECCION',
  VENDIENDO_CANTIDAD: 'VENDIENDO_CANTIDAD',
  VENDIENDO_CONFIRMACION: 'VENDIENDO_CONFIRMACION',
  SELECCIONANDO_PRODUCTO_GRUPO: 'SELECCIONANDO_PRODUCTO_GRUPO',
  ASIGNANDO_GRUPO: 'ASIGNANDO_GRUPO',
  SELECCIONANDO_GRUPO: 'SELECCIONANDO_GRUPO',
  IMPORTANDO_ESPERANDO_ARCHIVO: 'IMPORTANDO_ESPERANDO_ARCHIVO',
  IMPORTANDO_REVISANDO: 'IMPORTANDO_REVISANDO',
} as const;
